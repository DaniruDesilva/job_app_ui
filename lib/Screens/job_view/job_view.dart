                ...
                tabIndex == 0
                    ? Padding(
                        ...
                        child: Container(
                          ...
                          child: const Text(
                              "UX (user experience) designers measure and optimise applications (usually web based) to improve ease of use (usability), and create the best user experience by exploring many different approaches to solve end-users' problems - conducting in-person user tests to observe behaviour, for example."),
                        ),
                      )
                    : tabIndex == 1
                        ? const Text("Company")
